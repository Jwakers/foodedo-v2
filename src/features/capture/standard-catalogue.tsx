...
import { CatalogueSaveStateProvider } from "./catalogue-save-state";
    ...
    <section aria-labelledby="catalogue-heading" className="mt-16">
      <div className="max-w-2xl">
        ...
        <h2
          ...
          className="mt-3 font-display text-4xl leading-tight tracking-[-0.025em] text-foreground sm:text-5xl"
        >
...
function CatalogueMealView({
  ...
  return (
    <article className="grid gap-6 border-b border-border py-10 sm:grid-cols-[4rem_1fr] sm:gap-8">
      <p
      ...
      <div>
        <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-start">
          <div>
            <h3 className="font-display text-3xl leading-tight tracking-[-0.02em] text-foreground">
              {meal.title}
            </h3>
            {meal.description ? (
        ...
        <details className="group mt-7 border-t border-border">
          <summary className="flex min-h-12 cursor-pointer list-none items-center justify-between py-3 text-sm font-semibold text-foreground focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-foreground">
          ...
          <div className="grid gap-8 pb-3 pt-5 md:grid-cols-2">
            <div>
              <h4 className="text-xs font-bold tracking-[0.16em] text-accent uppercase">
                Ingredients
              </h4>
            ...
            <div>
              ...
              <ol className="mt-4 space-y-4 text-sm leading-6 text-foreground">
